...
def show_progress(agent, grid_dim = 10, num_food = 1, window_size = 11, snake_length = 3, num_steps = 100):
...
def show_progress_multi_agent(agents, grid_dim = 10, num_food = 1, window_size = 11, snake_length = 3, num_steps = 100):
    env = SnakeEnv(
